...
image_path = "\\Project\\Output_Test\\"
#annotation_path = 'scans/raw_annotation/'
#annotation_path = "\\Project\\MassSegmentationMasksCopia\\"
annotation_path = "\\Project\\MassMasks_8b\\"

#save_image_path = "scans/preprocessed_image/"
save_image_path = "\\Project\\preprocessed_image\\"
if not os.path.exists(save_image_path):
    os.mkdir(save_image_path)

save_mask_path = "\\Project\\preprocessed_mask\\"
